                ...
                <ModalBody>
                    <Card>
                        <CardBody>
                            <h3>Quick guide</h3>
                            <ListGroup>
                                <ListGroupItem>Set a description for your connection,</ListGroupItem>
                                <ListGroupItem>Unlock, change, then re-lock the schedule,</ListGroupItem>
                                <ListGroupItem>Add a fixture, decide its VLAN and bandwidth and lock it,</ListGroupItem>
                                ...
                                <ListGroupItem>Verify pipe topology; click on junction to add more pipes</ListGroupItem>
                                <ListGroupItem>Click on each pipe, set parameters, and lock,</ListGroupItem>
